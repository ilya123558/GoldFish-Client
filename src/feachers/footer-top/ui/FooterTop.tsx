...
import { useGetCotalogsQuery } from "@/entities/cotalog"
...
export const FooterTop = () => {
  const { isLoading, isError, data } = useGetCotalogsQuery(null)

  return (
    <Container className="flex justify-between text-white p-[60px_0px_86px]">
      <div className="max-w-[220px]">
        <Link href='/'>
          <Image priority width={157} height={37} alt="logo" src={logo} />
        </Link>
      ...
      <div className="flex flex-col items-end text-[16px] font-bold">
        <Button className="bg-transparent w-[255px] h-[51px] mb-[26px]" clickHandle={() => { }}>
